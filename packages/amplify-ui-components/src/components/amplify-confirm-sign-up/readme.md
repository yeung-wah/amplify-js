...
| `headerText`            | `header-text`        | Used for header text in confirm sign up component                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | `string`                                            | `I18n.get(Translations.CONFIRM_SIGN_UP_HEADER_TEXT)`        |
| `submitButtonText`      | `submit-button-text` | Used for the submit button text in confirm sign up component                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | `string`                                            | `I18n.get(Translations.CONFIRM_SIGN_UP_SUBMIT_BUTTON_TEXT)` |
