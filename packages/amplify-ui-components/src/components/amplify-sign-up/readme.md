...
| `haveAccountText`       | `have-account-text`  | Used for the submit button text in sign up component                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | `string`                                            | `I18n.get(Translations.SIGN_UP_HAVE_ACCOUNT_TEXT)`  |
| `headerText`            | `header-text`        | Used for header text in sign up component                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | `string`                                            | `I18n.get(Translations.SIGN_UP_HEADER_TEXT)`        |
| `signInText`            | `sign-in-text`       | Used for the submit button text in sign up component                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | `string`                                            | `I18n.get(Translations.SIGN_IN_TEXT)`               |
| `submitButtonText`      | `submit-button-text` | Used for the submit button text in sign up component                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | `string`                                            | `I18n.get(Translations.SIGN_UP_SUBMIT_BUTTON_TEXT)` |
