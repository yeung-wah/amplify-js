...
const logger = new Logger('CognitoPlugin');
 ...
 */
export class CognitoPlugin implements AuthProvider {
	...
	private pendingSignIn: ReturnType<CognitoPlugin['signInWithPassword']> | null;
